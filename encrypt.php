...
function closeNav() {
  document.getElementById("mySidenav").style.width = "0";
    ...
    <div class="container">
      <div class="ele1">
        <div class="col-12" >
          <h1 id="heading"> File  Encryption</h1>
        </div>
      </div>
      <?php if ($error != '') { ?>
      <div class="row">
      ...
      <form class="form" enctype="multipart/form-data" method="post" id="form1" name="form1" auto-complete="off">
		...
		<div class="form-row">
          <div class="form-group">
            <label for="file"><h5><kbd>File</kbd><h5></label>
	   ...
	   <div class="form-row">
          <div class="form-group">
            <label for="password"><h5><kbd>Encryption-key</kbd></h5></label>
			</br>
       ...
       <div class="form-row">
          <div class="form-group">
         <label for="action"><h5><kbd>Action</kbd></h5></label>
    ...
    <div class="button-row"> 
          ...
          <button type="submit"  class="btn btn-success" id ="execute" onclick="setTimeout('document.form1.reset();',1000)">Encrypt</button>
	...
	<div align="center">
	 <button class ="btn btn-danger" onclick="window.location.href = 'upload.php'">Upload files</button>
	 </div>
<!--	<div class ="container">
   <div  class="row">
       <form action ="move.php" method ="post" enctype="multipart/form-data">
	        <div >
            <h3><font color="black">Upload Files</h3><br>
		   </div>
		 ...
		 <div align="left">
		  ...
		  <div align="right">
   <button class ="btn btn-danger" onclick="window.location.href = 'download.php'  ">Download files</button>
</div>
 </div> -->
